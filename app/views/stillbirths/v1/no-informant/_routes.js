...
// });
  ...
  // TASK LIST
  router.get('/v1/no-informant/task-list-noi-form', (req, res) => {
    req.session.data = req.session.data || {};
    res.render('task-list', { data: req.session.data });
  });
  // 1. Supporting info
  // 1.1: Prepare for appointment
  router.get('/v1/no-informant/prepare-for-appointment-form', (req, res) => {
    res.render('supporting-info/prepare-for-appointment', { data: req.session.data });
  });

  router.post('/v1/no-informant/prepare-for-appointment-form', (req, res) => {
    ...
    res.redirect('/v1/no-informant/submit/check-answers-page');
  } else {
  ...
  // 1.2: Uploads
  router.get('/v1/no-informant//uploads-form', (req, res) => {
    res.render('supporting-info/uploads', { data: req.session.data });
  });

  router.post('/v1/no-informant/uploads-form', (req, res) => {
    req.session.data = req.session.data || {};
    ...
    // 1.2: Comments
  router.get('/v1/no-informant/comments-form', (req, res) => {
    res.render('supporting-info/comments', { data: req.session.data });
  });

  router.post('/v1/no-informant/comments-form', (req, res) => {
    req.session.data = req.session.data || {};
   ...
   // 2. Source of medical information
    ...
    // 2.1: Cause of death
  router.get('/v1/no-informant/cause-of-death-form', (req, res) => {
    res.render('cause-of-death/cause-of-death.html', { data: req.session.data });
  });

  router.post('/v1/no-informant/cause-of-death-form', (req, res) => {
    req.session.data = req.session.data || {};
   ...
   // 2.2 : Coroner details
  router.get('/v1/no-informant/coroner-details-form', (req, res) => {
    res.render('cause-of-death/coroner-details', { data: req.session.data });
  });

  router.post('/v1/no-informant/coroner-details-form', (req, res) => {
    req.session.data = req.session.data || {};
  ...
  router.get('/v1/no-informant/medical-info-check-form', (req, res) => {
    res.render('cause-of-death/medical-info-check', { data: req.session.data });
  });

  router.post('/v1/no-informant/medical-info-check-form', (req, res) => {
    req.session.data = req.session.data || {};
  ...
  router.get('/v1/no-informant/whose-details-form', (req, res) => {
    req.session.data = req.session.data || {};
  ...
  router.post('/v1/no-informant/whose-details-form', (req, res) => {
    req.session.data = req.session.data || {};
...
// 4.1 child name, sex, date
  router.get('/v1/no-informant/name-date-form', (req, res) => {
    res.render('child-details/name-date', { data: req.session.data });
  });

  router.post('/v1/no-informant/name-date-form', (req, res) => {
    req.session.data = req.session.data || {};
  ...
  router.get('/v1/no-informant/place-of-stillbirth-form', (req, res) => {
    res.render('child-details/place-of-stillbirth', { data: req.session.data });
  });

  router.post('/v1/no-informant/place-of-stillbirth-form', (req, res) => {
    req.session.data = req.session.data || {};
    ...
    // 4.3 parents details
  router.get('/v1/no-informant/parents-details-form', (req, res) => {
    res.render('child-details/parents-details', { data: req.session.data });
  });

  router.post('/v1/no-informant/parents-details-form', (req, res) => {
    req.session.data = req.session.data || {};
...
// 7.1 Registrars details
  router.get('/v1/no-informant/register-page-form', (req, res) => {
    res.render('submit/register-page', { data: req.session.data });
  });

  router.post('/v1/no-informant/register-page-form', (req, res) => {
    req.session.data = req.session.data || {};
...
router.get('/v1/no-informant/submit/check-answers-page', (req, res) => {
...
// 🔍 Add this line to inspect session data
  ...
  res.render('/v1/no-informant/submit/check-answers-page', { data: req.session.data });
});
